...
class File_PDF {
     ...
     */
    static function &factory($orientation = 'P', $unit = 'mm', $format = 'A4', $width=0, $height=0)
    {
...
//            return;
    ...
    function image($file, $x, $y, $width = 0, $height = 0, $type = '', $link = '')
    {
        if (!isset($this->_images[$file])) {
			...
			if (PEAR::isError($this->_images)) {print_r($this->_images); die();}
			if (PEAR::isError($info)) {print_r($info); die();}
